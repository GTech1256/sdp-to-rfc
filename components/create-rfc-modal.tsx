...
export function CreateRFCModal({ isOpen, onClose, onSubmit }: CreateRFCModalProps) {
    ...
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="glass-card border-white/20 max-w-md">
        <DialogHeader className="text-center pb-4">
          <div className="w-16 h-16 rounded-2xl crypto-gradient flex items-center justify-center mx-auto mb-4">
          ...
          <p className="text-gray-400 text-sm">
            Начните автоматизацию вашего процесса
          </p>
        </DialogHeader>
